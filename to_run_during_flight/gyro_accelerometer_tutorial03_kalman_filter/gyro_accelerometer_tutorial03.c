...
int main(int argc, char *argv[])
{
	...
	// This piece of code is added by Lisa, to write the output to file
	FILE *f = fopen("kalman_output.txt", "w");
	...
	*/
	...
	//Write to file f
	fprintf(f, "\033[22;31mkalmanX %7.3f  \033[22;36mkalmanY %7.3f\t\e[m",kalmanX,kalmanY);
	...
	//Writes to file f
	fprintf(f, "GyroX  %7.3f \t AccXangle \e[m %7.3f \t \033[22;31mCFangleX %7.3f\033[0m\t GyroY  %7.3f \t AccYangle %7.3f \t \033[22;36mCFangleY %7.3f\t\033[0m\n", gyroXangle,AccXangle,CFangleX,gyroYangle,AccYangle,CFangleY);
	...
	//Write to file f
	fprintf(f, "Loop Time %d\t", mymillis() - startInt);
	//fclose(f);
    }
