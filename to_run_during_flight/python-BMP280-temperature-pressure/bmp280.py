...
while True:
    ...
    var2 = var1 * var1 * (dig_P6) / 32768.0# BMP280 address, 0x77
    # Read data back from 0x88(136), 24 bytes
    b1 = bus.read_i2c_block_data(0x77, 0x88, 24)
    ...
    #Celsius, Fahrenheit, pressue(hPa)
    f.write("%.2f, %.2f, %.2f\n" %(cTemp,fTemp,pressure))
    f.close()
    time.sleep(30)
